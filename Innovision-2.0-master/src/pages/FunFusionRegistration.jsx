                    ...
                    {status === 'success' ? (
                        <div className="flex flex-col items-center justify-center py-6 sm:py-8 text-center">
                            ...
                            <div className="relative bg-gradient-to-br from-gray-900/80 via-black/60 to-gray-800/80 border border-white/10 rounded-2xl p-6 mb-6 w-full max-w-md backdrop-blur-sm overflow-hidden">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/5 via-transparent to-violet-500/5"></div>
                                ...
                                <div className="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-violet-500/10 to-transparent rounded-full blur-xl"></div>
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="text-center mb-5">
                                        <h4 className="text-white font-bold text-lg mb-2 font-orbitron">Join the Fun Squad</h4>
                                        <p className="text-gray-300 text-sm leading-relaxed">
                                            Connect with your teammates and get real-time updates about the fun activities
                                        </p>
                                    </div>
                                    
                                    <a
                                        href="https://chat.whatsapp.com/ByCQTmxfaJnFnT3biJea1O"
                                        target="_blank"
                                    ...
                                    >
                                        ...
                                        <span className="relative z-10">Join Fun Fusion Team</span>
                                    ...
                                    <div className="flex items-center justify-center mt-4 text-xs text-gray-400">
                                        ...
                                        <span>Game updates • Team coordination • Fun activities</span>
                                    </div>
                                </div>
                            </div>
