                            ...
                            <div className="relative bg-gradient-to-br from-gray-900/80 via-black/60 to-gray-800/80 border border-white/10 rounded-2xl p-6 mb-6 w-full max-w-md backdrop-blur-sm overflow-hidden">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="flex items-center justify-center mt-4 text-xs text-gray-400">
                                        ...
                                        <span>Tech tips • Competition updates • Community support</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-2 sm:space-y-3 md:space-y-4">
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-2 mt-2">
                                    <p className="text-red-300 text-[9px] sm:text-[10px] font-medium">
                                        ⚠️ College ID photo is mandatory for registration. Take a clear photo of your college ID card.
                                    </p>
                                </div>
                            </div>
